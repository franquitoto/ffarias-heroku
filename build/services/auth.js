    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 6:
            _logger.logger.trace('ENCONTRE UN USUARIO');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 8:
            ...
            _logger.logger.error("Hubo un error ".concat(_context2.t0));
...
_passport["default"].serializeUser(function (user, done) {
  _logger.logger.trace('Se Ejecuta el serializeUser');
...
_passport["default"].deserializeUser(function (userId, done) {
  _logger.logger.trace('Se Ejecuta el desserializeUser');
