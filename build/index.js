...
var _databases = require("./services/databases");
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return (0, _databases.initMongoDB)();

          case 2:
            _server["default"].listen(puerto, function () {
              return _logger.logger.info("server up on port ".concat(puerto, " PID WORKER ").concat(n));
            });
...
if (modoCluster === "cluster") {
  ...
  if (_cluster["default"].isPrimary) {
    ...
    _cluster["default"].on('exit', function (worker, code) {
      _logger.logger.warn("Worker ".concat(worker.process.pid, " died with code ").concat(code, " at ").concat(Date()));
